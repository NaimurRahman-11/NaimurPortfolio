...
const Intro = ({homeRef}) => {
    ...
    return (
        <div ref={homeRef} className="min-h-screen py-10 mt-5 pr-9">
            <Slide><div className="hero ">
                <div className="hero-content flex-col lg:flex-row-reverse lg:items-start justify-center">
                <motion.img
            src={image}
            className="max-w-sm rounded-lg shadow-2xl mb-8 lg:mb-0 lg:mr-8 lg:mt-0 lg:ml-4"
            drag
            dragConstraints={{
              top: 0,
              left: 0,
          ...
          />
                    <div className="text-center lg:text-left">
                        ...
                        <button className="btn btn-primary glow-on-hover" onClick={handleDownloadResume}>Download Resume <FiDownload></FiDownload></button>
                    </div>
                </div>
            </div></Slide>

            <Bounce><Count></Count></Bounce>
        </div>
    );
};
